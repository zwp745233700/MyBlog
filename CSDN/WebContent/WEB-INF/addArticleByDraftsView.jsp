...
<head>
	...
	<script type="text/javascript">
			...
			document.forms.articleForm.action="${pageContext.request.contextPath }/articleaction_takeTorecycleByDrafts.action";
			document.forms.articleForm.submit();
		}
	</script>
	<script type="text/javascript">
			function saveBtnClick(){
			document.forms.articleForm.action="${pageContext.request.contextPath }/articleaction_updDraft.action";
			document.forms.articleForm.submit();
		}
	</script>
...
<body>
    ...
    <div class="writeboke">
		...
		<div style="width:400px;margin:0 auto;">
			...
			<input type="button" value="保存" onclick="saveBtnClick()" />
